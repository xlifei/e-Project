...
import com.xulifei.e.dao.*;
import com.xulifei.e.entity.Page;
import com.xulifei.e.service.BaseService;
...
public class BaseServiceImpl<T> implements BaseService<T> {
    ...
    @Autowired
    protected TotalAttendanceInfomationMapper totalAttendanceInfomationMapper;

    @Autowired
    protected InviteCodeMapper inviteCodeMapper;

    @Autowired
    protected ClassMapper classMapper;

    @Autowired
    protected  PersonalAttendanceInformationTableMapper personalAttendanceInformationTableMapper;

    @Autowired
    protected  AttendanceRecordMapper attendanceRecordMapper;

    @Autowired
    protected  AttendanceDetailMapper attendanceDetailMapper;
